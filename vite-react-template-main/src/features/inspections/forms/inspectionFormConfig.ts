...
export const crownCheckboxes: ToggleField<CrownInspectionState>[] = [
  { key: 'abioticDisturbance', label: 'Abiotische Störung ' },
  { key: 'dying', label: 'Absterbend ' },
  { key: 'overloadedBranchOrCrown', label: 'Überlastete Krone/Ast ' },
  ...
  { key: 'bioticDisturbance', label: 'Biotische Störung ' },
  ...
  { key: 'longitudinalCrack', label: 'Längsriss ' },
  ...
  { key: 'openDecay', label: 'Offene Fäule ' },
  { key: 'withoutLeaderShoot', label: 'Ohne Leittrieb ' },
  { key: 'fungalFruitingBody', label: 'Fruchtkörper ' },
  { key: 'rubbingBranches', label: 'Reibende Äste ' },
  { key: 'slimeFlux', label: 'Schleimfluss ' },
  { key: 'secondaryCrowns', label: 'Sekundärkronen' },
  { key: 'woodpeckerHole', label: 'Spechthöhle ' },
  { key: 'compressionDamage', label: 'Druckschäden ' },
  { key: 'torsionCrack', label: 'Torsionsriss' },
  { key: 'deadwood', label: 'Totholz ' },
  { key: 'widowmakerBranch', label: 'Störerast/Widowmaker ' },
  { key: 'unfavorableCrownDevelopment', label: 'Ungünstige Kronenentwicklung ' },
...
export const trunkCheckboxes: ToggleField<TrunkInspectionState>[] = [
  ...
  { key: 'canker', label: 'Krebs ' },
  { key: 'longitudinalCrack', label: 'Längsriss ' },
  { key: 'mowingDamage', label: 'Mahdschäden ' },
  { key: 'burl', label: 'Maserknolle/Burl ' },
  { key: 'openDecay', label: 'Offene Fäule ' },
  { key: 'fungalFruitingBody', label: 'Fruchtkörper ' },
  { key: 'leaning', label: 'Geneigt ' },
  { key: 'slimeFlux', label: 'Schleimfluss ' },
  { key: 'secondaryRadialGrowthMissing', label: 'Sekundäres Dickenwachstum fehlt ' },
  { key: 'woodpeckerHole', label: 'Spechthöhle ' },
  { key: 'compressionDamage', label: 'Druckschäden ' },
  { key: 'torsionCrack', label: 'Torsionsriss ' },
  { key: 'deadwood', label: 'Totholz ' },
...
export const stemBaseCheckboxes: ToggleField<StemBaseInspectionState>[] = [
  ...
  { key: 'structuresNearTree', label: 'Strukturen in der Nähe ' },
  { key: 'bulgeOrSwelling', label: 'Beule/Schwellung ' },
  { key: 'foreignVegetation', label: 'Fremdbewuchs ' },
  ...
  { key: 'compressionDamage', label: 'Druckschäden ' },
  { key: 'overfilled', label: 'Aufgefüllt ' },
  { key: 'graftPoint', label: 'Veredlungsstelle ' },
  { key: 'girdlingRoot', label: 'Würgewurzel ' },
  { key: 'rootDamage', label: 'Wurzelschäden ' },
];
